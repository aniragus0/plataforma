...
<title>Informacion de Maestros</title>
...
function enviarDatos(){
 document.getElementById('cct').value="";
		...
		cedeprom = document.getElementById("cboCedeprom").value;
        //taller = document.getElementById("cboTalleres").value;
        ...
        ajax.onreadystatechange = function() {
            ...
            if (ajax.readyState == 4){
                ...
                cct.value = (ajax.responseText) 
		
		document.getElementById('cct').style.display="inline";
		
//document.getElementById('cct').value=("Lugares Disponibles  = " + contador.value);
document.getElementById('cct').value=(+cct.value);
...
<form action="editmtro.php" method="post" name="form" id="third" class="styleThese" style="background:#FFF">
  <center><span class="titulo"><strong>::: Informacion de Maestros :::</strong></span></center>
...
<!-- NOMBRE -->  
 <label for="nombre"><strong><span class="blue">*</span> NOMBRE :</strong><span class="styleThese" style="background:#FFF"><span class="styleThese" style="background:#FFF">
   <input id="id" name="id" type="hidden" size="5"  value="<?php echo $reg[0]["id"];?>" />
 </span></span></label>
<input id="nombre" name="nombre" type="text" class="validate['required']" size="45"style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();" value="<?php echo $reg[0]["nombre"];?>"> 
            
            <!-- APELLIDOS -->
<label for="apellidos"><strong><span class="blue">*</span>APELLIDOS:</strong></label>
<input id="apellidos" name="apellidos" type="text" class="validate['required']" size="45" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();"  value="<?php echo $reg[0]["apellidos"];?>"/>
...
<table width="450" border="0">
  <tr>
    <td width="228"><input id="rfc" name="rfc" type="text" class="validate['required','length[12,-1]']" size="30" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();"  value="<?php echo $reg[0]["rfc"];?>"/>
  <!-- .......................................... -->        
            
</td>
    <td width="196"><strong>
    <input id="curp" name="curp" type="text" class="validate['required','length[17,-1]']" size="30" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();"  value="<?php echo $reg[0]["curp"];?>"/>
</strong></td>
  </tr>
</table>
...
<!-- .......................................... -->           
  ...
  <table width="450" border="0">
  <tr>
    <td width="238"><select size="1" name="sexo" id="sexo"  >
         <option value= "<?php echo $reg[0]["sexo"];?>"><?php echo $reg[0]["sexo"];?></option>
          <option value="-------">-----------</option>
    ...
    <td width="202"><!-- GRADO DE ESTUDIOS --><strong>
      <input id="grado" name="grado" type="text" class="validate['required']" size="30" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();" value="<?php echo $reg[0]["grado"];?>" />
</strong></td>
  </tr>
</table>
...
<input id="municipio" name="municipio" type="text" class="validate['required']" size="21" />-->
  ...
  <label for="municipio"><strong><span class="blue">*</span> MUNICIPIO : </strong><span class="BLANCO"><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</strong></span><strong><span class="blue">*</span> LOCALIDAD : </strong></label>
    ...
    <td width="239"><select id="cboMunicipios" name="cboMunicipios"   >
...
<input id="localidad" name="localidad" type="text" class="validate['required']" size="30" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();" value="<?php echo $reg[0]["localidad"];?>"/>
</strong></td>
  </tr>
</table>
     <dd> 
...
<table width="450" border="0">
  ...
  <td width="239"><select id="cboCedeprom" name="cboCedeprom" onchange="enviarDatos(); return false"  >
                 <option value= "<?php echo $reg[0]["cedeprom"];?>"><?php echo $reg[0]["cedeprom"];?></option>
                 <option value="-">------------------</option>
...
<input id="nivel" name="nivel" type="text" class="validate['required']" size="30" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();"  value="<?php echo $reg[0]["nivel"];?>"/>
</strong></td>
  </tr>
</table>
...
<!-- .......................................... -->      
 ...
 <!-- MODALIDAD -->
  ...
  <table width="450" border="0">
  <tr>
    <td width="239"><input id="modalidad" name="modalidad" type="text" class="validate['required']" size="30" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();"  value="<?php echo $reg[0]["modalidad"];?>"/>        
            
</td>
    <td width="201"><!-- CCT --><strong>
<input id="cct" name="cct" type="text" class="validate['required','length[5,-1]']" size="30" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();" value="<?php echo $reg[0]["cct"];?>"/>
</strong></td>
  </tr>
</table>
...
<!-- Telefono -->
  ...
  <table width="450" border="0">
  <tr>
    <td width="239"><input id="telefono" name="telefono" type="text" class="validate['required','phone']" size="30"  value="<?php echo $reg[0]["telefono"];?>"/>
  <!-- .......................................... -->              
            
</td>
    <td width="201"><!-- EMAIL --><strong>
<input id="email" name="email" type="text" class="validate['required','email']" size="30" style="text-transform:lowercase;" onkeyup="javascript:this.value=this.value.toLowerCase();"  value="<?php echo $reg[0]["email"];?>"/>
</strong>
<!-- .......................................... --></td>
  </tr>
</table>
...
<textarea id="message" name="obs" type="text" class="validate['']" rows="5" cols="45" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();"   value="<?php echo $reg[0]["comentarios"];?>"></textarea>

		
		<br /><br />
        
		<input type="submit" class="buttonSubmit" value="Actualizar" />
