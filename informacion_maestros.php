...
<input id="nombre" name="nombre" type="text" class="validate['required']" size="45"style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();" disabled="disabled" value="<?php echo $reg[0]["nombre"];?>"> 
...
<table width="450" border="0">
  ...
  <!-- .......................................... -->        
    ...
    <td width="196"><strong>
    <input id="curp" name="curp" type="text" class="validate['required','length[17,-1]']" size="30" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();" disabled="disabled" value="<?php echo $reg[0]["curp"];?>"/>
</strong></td>
  </tr>
</table>
...
<!-- .......................................... -->           
  ...
  <table width="450" border="0">
  <tr>
    <td width="238"><select size="1" name="sexo" id="sexo" class="validate['select']" disabled="disabled">
         <option value= "0"><?php echo $reg[0]["sexo"];?></option>
              </select>        
            
</td>
    <td width="202"><!-- GRADO DE ESTUDIOS --><strong>
      <input id="grado" name="grado" type="text" class="validate['required']" size="30" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();" disabled="disabled" value="<?php echo $reg[0]["grado"];?>" />
</strong></td>
  </tr>
</table>
...
<input id="municipio" name="municipio" type="text" class="validate['required']" size="21" />-->
  ...
  <label for="municipio"><strong><span class="blue">*</span> MUNICIPIO : </strong><span class="BLANCO"><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</strong></span><strong><span class="blue">*</span> LOCALIDAD : </strong></label>
    ...
    <td width="239"><select id="cboMunicipios" name="cboMunicipios" class="validate['select']" disabled="disabled" >
                 <option value= "0"><?php echo $reg[0]["municipio"];?></option>
                
            </select>            
  
   
    <td width="200"><!-- LOCALIDAD --><strong>
<input id="localidad" name="localidad" type="text" class="validate['required']" size="30" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();" disabled="disabled" value="<?php echo $reg[0]["localidad"];?>"/>
</strong></td>
  </tr>
</table>
     <dd> 
...
<table width="450" border="0">
  ...
  <td width="239"><select id="cboCedeprom" name="cboCedeprom" onchange="enviarDatos(); return false" class="validate['select']" disabled="disabled" >
                 <option value= "0"><?php echo $reg[0]["cedeprom"];?></option>
...
<input id="nivel" name="nivel" type="text" class="validate['required']" size="30" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();" disabled="disabled" value="<?php echo $reg[0]["nivel"];?>"/>
</strong></td>
  </tr>
</table>
...
<!-- .......................................... -->      
 ...
 <!-- MODALIDAD -->
  ...
  <table width="450" border="0">
  <tr>
    <td width="239"><input id="modalidad" name="modalidad" type="text" class="validate['required']" size="30" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();" disabled="disabled" value="<?php echo $reg[0]["modalidad"];?>"/>        
            
</td>
    <td width="201"><!-- CCT --><strong>
<input id="cct" name="cct" type="text" class="validate['required','length[5,-1]']" size="30" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();" disabled="disabled" value="<?php echo $reg[0]["cct"];?>"/>
</strong></td>
  </tr>
</table>
...
<!-- Telefono -->
  ...
  <table width="450" border="0">
  <tr>
    <td width="239"><input id="telefono" name="telefono" type="text" class="validate['required','phone']" size="30" disabled="disabled" value="<?php echo $reg[0]["telefono"];?>"/>
  <!-- .......................................... -->              
            
</td>
    <td width="201"><!-- EMAIL --><strong>
<input id="email" name="email" type="text" class="validate['required','email']" size="30" style="text-transform:lowercase;" onkeyup="javascript:this.value=this.value.toLowerCase();" disabled="disabled" value="<?php echo $reg[0]["email"];?>"/>
</strong>
<!-- .......................................... --></td>
  </tr>
</table>
...
<textarea id="message" name="obs" type="text" class="validate['']" rows="5" cols="45" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();" disabled="disabled" value="<?php echo $reg[0]["comentarios"];?>"></textarea>
