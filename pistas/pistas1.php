...
<body>
<div id="top">
  <div id="top_context"><span id="logo_font">Reproducción de pistas</span> 
...
<div id="main">
       ...
       <!--  <? echo $type_list ?>
    	...
    	<input type="submit" name="button" id="button" value="Search" />--><div id="player">
     <div id="player_font">Control de Música</div>
	<div id="music_player"><script type="text/javascript">document.write(player("","0"));</script></div>
    </div>
    	</div>
