...
var FormCheck = new Class({
	options : {
		...
		alerts : {
			...
			alpha        : "Escriba Solo Letras...",
			alphanum     : "Este Campo Acepta Unicamente Datos Alfanumericos...",
			nodigit      : "Este Campo NO Acepta Numeros...",
			digit        : "Por Favor Ingrese Numeros Validos",
			digitmin     : "The number must be at least %0",
			digitltd     : "The value must be between %0 and %1",
			number       : "Capture un Numero Valido Por Favor...",
			email        : "Escriba un E-mail Correcto: <br /><span>Ejemplo: sunombre@suempresa.com</span>",
			spamcheck    : "<span>2 + 3 = ???</span>",
			phone        : "Capture un Numero de Telefono Valido",
			url          : "Please enter a valid url: <br /><span>E.g. http://www.domain.com</span>",
			confirm      : "This field is different from %0",
			differs      : "This value must be different of %0",
			length_str   : "Text is too short, it must be between %0 and %1",
			lengthmax    : "Text is too short, it must be at max %0",
			lengthmin    : "El Texto es Demasiado Corto, Debe Contener Como Minimo %0 Caracteres",
			checkbox     : "Please check the box",
			radios       : "Please select a radio",
